...
**Date:** 2026-07-26 (last re-verified 2026-07-27 — after the §1, §2, and §8 fixes landed, a pass to correct drifted file:line citations, and a follow-up `npm audit fix` once a local npm-cache permission blocker was resolved, which surfaced a new §2.6 finding)
