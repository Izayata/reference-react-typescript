import { convertRegistrationDataToNewPasswordDetailsModel } from '../../main/converter/NewPasswordDetailsModel'
import { ERR_MSG_NEW_PASSWORD_VALUE_DO_NOT_MATCH_CONFIRM_NEW_PASSWORD_VALUE } from '../../main/utils/PasswordChangeUtils'
