import { PasswordChangeModelBuilder } from '../../main/builder/PasswordChangeModelBuilder'
...
import { ERR_MSG_CURRENT_PASSWORD_REQUIRED, ERR_MSG_NEW_PASSWORD_DETAILS_REQUIRED } from '../../main/utils/PasswordChangeUtils'
