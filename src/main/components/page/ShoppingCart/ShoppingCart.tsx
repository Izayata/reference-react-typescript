    ...
    <>
      {!foods.length ?
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem'}}>
          <h1 className='page-title'>A kosár üres.</h1> 
          <img className='shopping-cart-no-food-image' src="https://memesgenerator.hu/wp-content/uploads/mememe/2025/04/kaja-nem-lesz-115308-1.jpg" alt="Nem lesz kaja meme dzsulien király" />
        </div>
        :
        <h2 className='page-title'>Kosár</h2>}
      {foods.length > 0 && (
